...
11. [x] 反转链表(reverse-linked-list)[leetcode 地址](https://leetcode-cn.com/problems/UHnkqh/)
12. [x] 链表相交(getIntersectionNode)[leetcode 地址](https://leetcode-cn.com/problems/intersection-of-two-linked-lists-lcci/)
13. [x] 旋转链表(rotate-list)[leetcode 地址](https://leetcode-cn.com/problems/rotate-list/)
14. [x] 数据流中的第 K 大元素(KthLargest)[leetcode 地址](https://leetcode-cn.com/problems/kth-largest-element-in-a-stream/)
15. [x] 翻转二叉树(invert-binary-tree)[leetcode 地址](https://leetcode-cn.com/problems/invert-binary-tree/)
...
33. [x] 两节点的最长路径[leetcode](https://leetcode-cn.com/problems/diameter-of-binary-tree/description/)
34. [x] 两个字符串包含的字符是否完全相同[leetcode](https://leetcode-cn.com/problems/valid-anagram/description/)
35. [x] 计算一组字符集合可以组成的回文字符串的最大长度[leetcode](https://leetcode-cn.com/problems/longest-palindrome/description/)
...
41. [x] 链表中倒数第 k 个节点[leetcode](https://leetcode-cn.com/problems/lian-biao-zhong-dao-shu-di-kge-jie-dian-lcof/)
...
62. [x] 面试题第 k 个数 [leetcode](https://leetcode-cn.com/problems/get-kth-magic-number-lcci)
...
72. [x] 剑指 Offer 复杂链表的复制[leetcode](https://leetcode-cn.com/problems/fu-za-lian-biao-de-fu-zhi-lcof)
...
85. [x] 第 K 个语法符号[leetcode](https://leetcode-cn.com/problems/k-th-symbol-in-grammar)
86. [x] 完全二叉树的节点个数[leetcode](https://leetcode-cn.com/problems/count-complete-tree-nodes)

#### 2021.12.10-12.12 第十八套

87. [x] 剑指 Offer：二叉搜索树的第 k 大节点[leetcode](https://leetcode-cn.com/problems/er-cha-sou-suo-shu-de-di-kda-jie-dian-lcof)
...
94. [ ] 剑指 Offer：从上到下打印二叉数 II[leetcode](https://leetcode-cn.com/problems/cong-shang-dao-xia-da-yin-er-cha-shu-ii-lcof)
...
102. [ ] 数组中的第 K 个最大元素 [leetcode](https://leetcode-cn.com/problems/kth-largest-element-in-an-array)
103. [ ] 设计推特 [leetcode](https://leetcode-cn.com/problems/design-twitter)
104. [ ] 前 K 个高频单词 [leetcode](https://leetcode-cn.com/problems/top-k-frequent-words)
...
113. [x] 二叉搜索树中第 K 小的元素 [leetcode](https://leetcode-cn.com/problems/kth-smallest-element-in-a-bst)
...
139. [x] 面试题 17.14. 最小 K 个数 [leetcode](https://leetcode-cn.com/problems/smallest-k-lcci)
...
146. [ ] 合并 K 个升序链表 [leetcode](https://leetcode-cn.com/problems/merge-k-sorted-lists)
...
149. [ ] 计算右侧小于当前元素的个数 [leetcode](https://leetcode-cn.com/problems/count-of-smaller-numbers-after-self)
...
166. [x] 字符频次唯一的最小删除次数 [leetcode](https://leetcode-cn.com/problems/minimum-deletions-to-make-character-frequencies-unique/)
167. [x] 移动零 [leetcode](https://leetcode-cn.com/problems/move-zeroes/)
168. [x] 面试题 10.01. 合并排序的数组 [leetcode](https://leetcode-cn.com/problems/sorted-merge-lcci/)
169. [x] 数组拆分 I [leetcode](https://leetcode-cn.com/problems/array-partition-i/)
...
176. [ ] 供暖器 [leetcode](https://leetcode-cn.com/problems/heaters/)
177. [ ] 搜索旋转排序数组 II [leetcode](https://leetcode-cn.com/problems/search-in-rotated-sorted-array-ii/)
178. [ ] 寻找两个正序数组的中位数 [leetcode](https://leetcode-cn.com/problems/median-of-two-sorted-arrays/)
179. [ ] 最长递增子序列 [leetcode](https://leetcode-cn.com/problems/longest-increasing-subsequence/)
180. [ ] 在 D 天内送达包裹的能力 [leetcode](https://leetcode-cn.com/problems/capacity-to-ship-packages-within-d-days/)
181. [x] 最大单词长度乘积 [leetcode](https://leetcode-cn.com/problems/maximum-product-of-word-lengths/)
182. [ ] 搜索二维矩阵 II [leetcode](https://leetcode-cn.com/problems/search-a-2d-matrix-ii/)
183. [ ] 在二叉树中分配硬币 [leetcode](https://leetcode-cn.com/problems/distribute-coins-in-binary-tree/)
184. [ ] 扁平化多级双向链表 [leetcode](https://leetcode-cn.com/problems/flatten-a-multilevel-doubly-linked-list/)
185. [ ] 二叉树中所有距离为 K 的结点 [leetcode](https://leetcode-cn.com/problems/all-nodes-distance-k-in-binary-tree/)
